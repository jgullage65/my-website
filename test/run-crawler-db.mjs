...
if (!databaseUrl) {
  console.error("DATABASE_URL_TEST is required. Refusing to skip the crawler PostgreSQL integration suite.");
  process.exit(1);
}
...
catch { console.error("DATABASE_URL_TEST must be a valid PostgreSQL connection URL."); process.exit(1); }
...
const result = spawnSync(process.execPath, [
  ...
  "--test", "app/lib/ai-engine/crawler/crawlJobStore.integration.test.ts",
