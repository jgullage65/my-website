    ...
    <div className="overflow-hidden bg-[#030713] text-white">
      <Section className="relative mx-auto grid max-w-[94rem] gap-12 px-5 pb-16 pt-16 sm:px-8 lg:grid-cols-[.82fr_1.18fr] lg:px-10 lg:pb-24 lg:pt-24">
        ...
        <motion.div variants={fadeUp} className="relative z-10 self-center text-center">
          ...
          <h1 className="mx-auto mt-5 max-w-4xl text-5xl font-black leading-[.94] tracking-[-.065em] sm:text-6xl xl:text-[5.25rem]">A creative technology studio for <span className="text-[var(--gold)]">modern business.</span></h1>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-[var(--muted)] sm:text-lg">JG Creative Studio helps businesses look sharper, communicate clearly, and operate smarter through premium websites, AI systems, automation, and custom business technology.</p>
          <p className="mx-auto mt-5 max-w-2xl leading-8 text-slate-300">I’m James Gullage, a founder, developer, stay-at-home dad, and lifelong technology learner. I care about making advanced tools feel practical, understandable, and genuinely useful for the people running the business.</p>
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><GoldButton href="/contact">Start a Project</GoldButton><OutlineButton href="/services">View Services</OutlineButton></div>
        </motion.div>
      </Section>
      ...
      <Section className="mx-auto grid max-w-[94rem] gap-10 border-b border-[rgba(212,175,55,.10)] px-5 py-20 sm:px-8 lg:grid-cols-[.9fr_1.1fr] lg:px-10">
        <motion.div variants={fadeUp} className="self-center text-center">
          ...
          <h2 className="mx-auto mt-4 max-w-3xl text-4xl font-black leading-[.96] tracking-[-.055em] sm:text-6xl"><span className="text-[var(--gold)]">Better businesses</span> deserve better digital systems.</h2>
          <p className="mx-auto mt-6 max-w-2xl leading-8 text-[var(--muted)]">A lot of businesses do excellent work, but their website, marketing, software, or internal process does not reflect that quality. JG Creative Studio exists to close that gap with technology that feels premium on the outside and practical behind the scenes.</p>
        </motion.div>
      ...
      <Section className="mx-auto max-w-[94rem] px-5 py-10 sm:px-8 lg:px-10">
        <motion.div variants={fadeUp} className="mx-auto flex max-w-3xl flex-col items-center justify-center gap-5 rounded-2xl border border-[rgba(212,175,55,.18)] bg-[#050b18] p-5 text-center shadow-[0_18px_50px_rgba(0,0,0,.28)] sm:p-6">
          <div>
            ...
            <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-[var(--muted)]"><span className="font-black text-white">Bring the business problem.</span> I’ll help choose the cleanest path.</p>
          </div>
          <div className="flex shrink-0 flex-col justify-center gap-3 sm:flex-row"><GoldButton href="/contact">Contact</GoldButton><OutlineButton href="/ai-tools">AI Systems</OutlineButton></div>
        </motion.div>
      </Section>
    </div>
  );
