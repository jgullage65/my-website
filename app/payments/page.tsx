export const metadata = {
    ...
    Pay securely online to start your project. Deposits lock in your spot and we’ll confirm
    the final quote after a quick message.
    </p>
    </header>
    ...
    After payment, I’ll reply and confirm the next steps.
    </p>
    <p className="text-slate-600">
    Deposits are applied toward your project total. Final pricing depends on scope and is
