        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 md:p-10">
          <div className="text-center">
            ...
            <p className="mt-2 text-slate-600 max-w-2xl mx-auto">
              Simple process, clear communication, and no surprises.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-2 text-slate-700">
                Tell me what you need and what your goal is.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-2 text-slate-700">
                I confirm scope, timeline, and the best option for you.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-2 text-slate-700">
                I build it, you review, and we polish it.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 md:col-span-2">
              ...
              <p className="mt-2 text-slate-700">
                We publish it and I’m here for updates if needed.
              </p>
            </div>
          </div>
