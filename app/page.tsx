  ...
  return (
    <div className="overflow-hidden bg-[#020817] text-white">
      <Section className="max-[640px]:px-[0.1px] relative mx-auto grid max-w-[94rem] gap-10 px-0 pb-14 pt-0 min-[1200px]:grid-cols-[.9fr_1.1fr] min-[1200px]:px-10 min-[1200px]:py-20">
        ...
        <motion.div variants={mediaIn} className="relative z-10 order-1 self-center min-[1200px]:order-2">
          ...
          <ProductMedia
            ...
            ratio="aspect-[16/11]"
            className="rounded-none border-x-0 min-[1200px]:rounded-[1.6rem] min-[1200px]:border-x"
          />
        </motion.div>
      </Section>
