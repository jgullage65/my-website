...
export default function HomePage() {
  ...
  return (
    <div className="overflow-hidden bg-[#030713] text-white">
      <Section className="relative mx-auto grid max-w-[94rem] gap-10 px-5 py-14 sm:px-8 sm:py-16 lg:grid-cols-[.9fr_1.1fr] lg:px-10 lg:py-20">
        ...
        <motion.div variants={mediaIn} className="relative z-10 self-center">
