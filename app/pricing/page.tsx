export const metadata = {
    ...
    Simple <span className="font-semibold">starting prices</span> for common projects.
    I’m just getting started, so everything is priced reasonably — and I’ll confirm your exact quote before we begin.
    </p>
    </header>
    ...
    Clean, mobile-friendly websites designed to help you look professional and get more customers.
    </p>
    ...
    Includes updates, edits, small fixes, and keeping your site current.
    </p>
    </div>
    </div>
    ...
    <PriceCard
    title="AI Template Setup"
    price="$39+"
    desc="Reusable scripts and workflows."
    items={[
    "Customer reply templates",
    "Simple intake/checklists",
    "Easy weekly reuse",
    ]}
    featured
    />
    ...
    <p className="mt-2 text-slate-600">
    Want to start small? My First Project Special is customized depending on what you need —
    flyer, website help, posting, or admin support.
    </p>
    
    <p className="mt-4 font-semibold text-slate-900">
    Pricing is discussed after a quick message so it fits the exact project.
    </p>
    </div>
    ...
    Message me what you need and I’ll respond with a clear price and timeline.
    </p>
