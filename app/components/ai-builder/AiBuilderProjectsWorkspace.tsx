      ...
      <div className="relative hidden h-full min-h-0 w-full overflow-hidden border-y border-white/[0.08] bg-[#020202] xl:grid xl:grid-cols-[208px_minmax(0,1fr)_400px] min-[1500px]:grid-cols-[220px_minmax(0,1fr)_420px]">
        <aside className="flex min-h-0 flex-col border-r border-white/[0.08] bg-[#050505] px-4 py-5">
          ...
          <nav className="mt-3 space-y-0.5">
            <Link href="/brain-builder/new" className="block w-full rounded-lg px-3 py-2.5 text-left text-[0.82rem] font-semibold text-white transition hover:bg-white/[0.035]">
              Brain Builder
            </Link>
            <Link href="/brain-builder/projects" className="relative block w-full rounded-lg bg-white/[0.055] px-3 py-2.5 text-left text-[0.82rem] font-semibold text-amber-200 before:absolute before:bottom-2 before:left-0 before:top-2 before:w-0.5 before:rounded-full before:bg-amber-300">
              Projects
            </Link>
          </nav>
