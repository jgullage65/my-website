export default function AiBuilderWelcome({onContinue}:{onContinue:()=>void}){
    ...
    <button onClick={onContinue} className="rounded-xl border border-amber-300/15 bg-[#080808] px-5 py-3 font-semibold text-white hover:border-amber-300/30 hover:bg-[#111111]">Get Started</button>
    </div>;
    }
