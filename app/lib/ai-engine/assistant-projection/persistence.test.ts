...
test("write validation accepts generator-format fingerprints and rejects malformed metadata and payloads", () => {
  ...
  for (const [changed, code] of [[{ businessMemoryFingerprint: "fingerprint-1" }, "invalid_payload"], [{ services: {} }, "invalid_payload"], [{ identity: null }, "invalid_payload"], [{ identity: { status: "unknown" } }, "invalid_payload"], [{ assistant: [] }, "invalid_payload"], [{ projectId: "project-2" }, "project_id_mismatch"], [{ businessMemoryFingerprint: "business_memory_abcdef0123456789abcdef01" }, "fingerprint_mismatch"], [{ projectionVersion: 3 }, "invalid_payload"], [{ schemaVersion: 3 }, "invalid_payload"]] as const) {
...
test("persisted rows reject malformed payloads, metadata, state, and timestamps", () => {
  const value = projection("project-1");
  for (const [changed, code] of [[{ business_memory_fingerprint: "fingerprint-1" }, "row_fingerprint"], [{ projection_json: { ...value, businessMemoryFingerprint: "fingerprint-1" } }, "invalid_projection_json"], [{ projection_json: { ...value, projectId: "project-2" } }, "row_project_id_mismatch"], [{ projection_json: { ...value, businessMemoryFingerprint: "business_memory_abcdef0123456789abcdef01" } }, "row_fingerprint_mismatch"], [{ projection_json: { ...value, projectionVersion: 3 } }, "invalid_projection_json"], [{ projection_json: { ...value, schemaVersion: 3 } }, "invalid_projection_json"], [{ invalidation_state: "unknown" }, "row_invalidation_state"], [{ generated_at: "bad" }, "row_generated_at"], [{ created_at: "bad" }, "row_created_at"], [{ updated_at: "bad" }, "row_updated_at"], [{ projection_json: { ...value, services: "not-array" } }, "invalid_projection_json"], [{ projection_json: { ...value, identity: null } }, "invalid_projection_json"], [{ projection_json: { ...value, identity: { status: "unknown" } } }, "invalid_projection_json"], [{ projection_json: { ...value, assistant: [] } }, "invalid_projection_json"], [{ projection_json: { ...value, missingInformation: undefined } }, "invalid_projection_json"]] as const) {
