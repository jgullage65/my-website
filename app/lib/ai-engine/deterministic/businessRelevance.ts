...
function addCommercialPageFacts(facts: readonly DeterministicFact[], blocks: readonly NormalizedSourceBlock[]) {
...
export function recoverCommercialPageFacts(facts: readonly DeterministicFact[], blocks: readonly NormalizedSourceBlock[]) {
  return [...facts, ...addCommercialPageFacts(facts, blocks)];
}

/** @deprecated Use recoverCommercialPageFacts. Kept temporarily to avoid breaking older imports. */
export function improveBusinessRelevance(facts: DeterministicFact[], blocks: readonly NormalizedSourceBlock[]) {
  return recoverCommercialPageFacts(facts, blocks);
}
