...
export function buildDeterministicBusinessBrain(input: DeterministicEngineInput): DeterministicEngineResult {
    ...
    const relevanceCandidates = improveBusinessRelevance(rawCandidates, normalizedBlocks);
    const ownedCandidates = assignFactsToOwners(relevanceCandidates, routedBlocks);
