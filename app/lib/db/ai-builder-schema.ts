...
async function createAiBuilderSchema() {
  ...
  await sql`CREATE TABLE IF NOT EXISTS ai_builder_business_memory (id TEXT PRIMARY KEY, project_id TEXT NOT NULL UNIQUE REFERENCES ai_builder_projects(id) ON DELETE CASCADE, schema_version INTEGER NOT NULL, revision INTEGER NOT NULL, trusted_knowledge_revision INTEGER NOT NULL, created_at TIMESTAMPTZ NOT NULL, updated_at TIMESTAMPTZ NOT NULL)`;
