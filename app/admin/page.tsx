...
export default async function AdminOverviewPage() {
  ...
  return <div className="space-y-8"><PageHeader eyebrow="Operations" title="Dashboard overview" description="A live view of AI Builder customers, project momentum, and purchase intent." />
    <section aria-label="Key performance indicators" className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
    ...
    <section className={`${card} overflow-hidden`}><div className="relative flex flex-col items-center bg-amber-300/[.025] px-6 py-5 text-center"><p className="text-[10px] font-black uppercase tracking-[.18em] text-amber-300/60">Activity stream</p><h2 className="mt-1 text-xl font-bold text-white">What’s happening now</h2><div className="mt-3"><Badge tone="gold">Live data</Badge></div></div>
