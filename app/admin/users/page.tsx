...
export default async function AdminUsersPage({ searchParams }: { searchParams: { q?: string; sort?: string; page?: string } }) {
  ...
  let users = (await listAdminUsers()).filter((u) => !q || [u.email,u.ownerName,u.businessName,u.clerkUserId].some((v) => v.toLowerCase().includes(q)));
